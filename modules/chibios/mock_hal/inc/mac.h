...
#else
event_source_t macGetReceiveEventSource(MACDriver *macp);
#endif
#endif
...
#else
size_t macWriteTransmitDescriptor(MACTransmitDescriptor *tdp,
                                  uint8_t *buf,
                                  size_t size);
#endif
...
#else
size_t macReadReceiveDescriptor(MACReceiveDescriptor *rdp,
                                uint8_t *buf,
                                size_t size);
#endif
...
#else
uint8_t *macGetNextTransmitBuffer(MACTransmitDescriptor *tdp,
                                  size_t size,
                                  size_t *sizep);
#endif
...
#else
const uint8_t *macGetNextReceiveBuffer(MACReceiveDescriptor *rdp,
                                       size_t *sizep);
#endif
