...
#else
void palInit(const PALConfig *config);
#endif
...
#endif
#else
uint32_t palReadPort(ioportid_t port);
#endif
...
#endif
#else
uint32_t palReadLatch(ioportid_t port);
#endif
...
#endif
#else
void palWritePort(ioportid_t port, uint32_t bits);
#endif
...
#endif
#else
void palSetPort(ioportid_t port, uint32_t bits);
#endif
...
#endif
#else
void palClearPort(ioportid_t port, uint32_t bits);
#endif
...
#endif
#else
void palTogglePort(ioportid_t port, uint32_t bits);
#endif
...
#endif
#else
uint32_t palReadGroup(ioportid_t port, ioportmask_t mask, uint32_t offset);
#endif
...
#endif
#else
void palWriteGroup(ioportid_t port, ioportmask_t mask, uint32_t offset, uint32_t bits);
#endif
...
#endif
#else
void palSetGroupMode(ioportid_t port, ioportmask_t mask, uint32_t offset, iomode_t mode);
#endif
...
#endif
#else
uint32_t palReadPad(ioportid_t port, uint32_t pad);
#endif
...
#endif
#else
void palWritePad(ioportid_t port, uint32_t pad, uint32_t bit);
#endif
...
#endif
#else
void palSetPad(ioportid_t port, uint32_t pad);
#endif
...
#endif
#else
void palClearPad(ioportid_t port, uint32_t pad);
#endif
...
#endif
#else
void palTogglePad(ioportid_t port, uint32_t pad);
#endif
...
#endif
#else
void palSetPadMode(ioportid_t port, uint32_t pad, iomode_t mode);
#endif
