...
#else
size_t bqSizeX(io_buffers_queue_t *bqp);
#endif
...
#else
size_t bqSpaceI(io_buffers_queue_t *bqp);
#endif
...
#else
void *bqGetLinkX(io_buffers_queue_t *bqp);
#endif
...
#else
bool ibqIsEmptyI(input_buffers_queue_t *ibqp);
#endif
...
#define ibqIsFullI(ibqp)                                                    \
  ...
  /*lint -restore*/
#else
bool ibqIsFullI(input_buffers_queue_t *ibqp);
#endif
...
#define obqIsEmptyI(obqp)                                                   \
  ...
  /*lint -restore*/
#else
bool obqIsEmptyI(output_buffers_queue_t *obqp);
#endif
...
#else
bool obqIsFullI(output_buffers_queue_t *obqp);
#endif
/** @} */
