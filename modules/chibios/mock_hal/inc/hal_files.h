...
#else
size_t fileStreamWrite(void *ip, const uint8_t *bp, size_t n);
#endif
...
#else
size_t fileStreamRead(void *ip, uint8_t *bp, size_t n);
#endif
...
#else
msg_t fileStreamPut(void *ip, uint8_t b);
#endif
...
#else
msg_t fileStreamGetError(void *ip);
#endif
...
#else
msg_t fileStreamGetSize(void *ip);
#endif
...
#else
msg_t fileStreamGetPosition(void *ip);
#endif
...
#else
msg_t fileStreamSeek(void *ip, fileoffset_t offset);
#endif
/** @} */
