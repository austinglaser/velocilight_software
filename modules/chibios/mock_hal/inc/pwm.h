...
#else
void pwmChangePeriodI(PWMDriver *pwmp, pwmcnt_t value);
#endif
...
#else
void pwmEnableChannelI(PWMDriver *pwmp, pwmchannel_t channel, pwmcnt_t width);
#endif
...
#else
void pwmDisableChannelI(PWMDriver *pwmp, pwmchannel_t channel);
#endif
...
#else
bool pwmIsChannelEnabledI(PWMDriver *pwmp, pwmchannel_t channel);
#endif
...
#else
void pwmEnablePeriodicNotificationI(PWMDriver *pwmp);
#endif
...
#else
void pwmDisablePeriodicNotificationI(PWMDriver *pwmp);
#endif
...
#else
void pwmEnableChannelNotificationI(PWMDriver *pwmp, pwmchannel_t channel);
#endif
