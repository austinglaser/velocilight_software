...
#else
usbstate_t usbGetDriverStateI(USBDriver *usbp);
#endif
...
#else
uint32_t usbGetFrameNumberX(USBDriver *usbp);
#endif
...
#else
bool usbGetTransmitStatusI(USBDriver *usbp, usbep_t ep);
#endif
...
#else
bool usbGetReceiveStatusI(USBDriver *usbp, usbep_t ep);
#endif
...
#else
size_t usbGetReceiveTransactionSizeX(USBDriver *usbp, usbep_t ep);
#endif
...
#else
void usbSetupTransfer(USBDriver *usbp, uint8_t *buf, size_t n, usbcallback_t endcb);
#endif
...
#else
void usbReadSetup(USBDriver *usbp, usbep_t ep, uint8_t *buf);
#endif
/** @} */
