...
#else
msg_t chnPutTimeout(void *ip, uint8_t b, systime_t time);
#endif
...
#else
msg_t chnGetTimeout(void *ip, systime_t time);
#endif
...
#else
size_t chnWriteTimeout(void *ip, const uint8_t *bp, size_t n, systime_t time);
#endif
...
#else
size_t chnRead(void *ip, uint8_t *bp, size_t n);
#endif
...
#else
size_t chnReadTimeout(void *ip, uint8_t *bp, size_t n, systime_t time);
#endif
/** @} */
...
#else
event_source_t chnGetEventSource(void *ip);
#endif
...
#else
void chnAddFlagsI(void *ip, eventflags_t flags);
#endif
/** @} */
