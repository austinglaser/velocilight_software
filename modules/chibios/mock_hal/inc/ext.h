...
#else
void extChannelEnableI(EXTDriver *extp, expchannel_t channel);
#endif
...
#else
void extChannelDisableI(EXTDriver *extp, expchannel_t channel);
#endif
...
#else
void extSetChannelMode(EXTDriver *extp,
