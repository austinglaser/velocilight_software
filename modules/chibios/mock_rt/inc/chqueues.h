...
#else
size_t chQSpaceI(io_queue_t * qp);
#endif
...
#else
void * chQGetLinkX(io_queue_t * qp);
#endif
/** @} */
...
#else
size_t chIQGetFullI(input_queue_t *iqp);
#endif
...
#else
size_t chIQGetEmptyI(input_queue_t *iqp);
#endif
...
#else
bool chIQIsEmptyI(input_queue_t *iqp);
#endif
...
#else
bool chIQIsFullI(input_queue_t *iqp);
#endif
...
#else
msg_t chIQGet(input_queue_t *iqp);
#endif
...
#else
size_t chOQGetFullI(output_queue_t *oqp);
#endif
...
#else
size_t chOQGetEmptyI(output_queue_t *oqp);
#endif
...
#else
bool chOQIsEmptyI(output_queue_t *oqp);
#endif
...
#else
bool chOQIsFullI(output_queue_t *oqp);
#endif
...
#else
msg_t chOQPut(output_queue_t *oqp, uint8_t b);
#endif
