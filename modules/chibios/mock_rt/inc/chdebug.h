...
#if CH_DBG_SYSTEM_STATE_CHECK == TRUE && !defined(MOCK_RT)
...
#if CH_DBG_SYSTEM_STATE_CHECK == FALSE && !defined(MOCK_RT)
...
/* When the trace feature is disabled this function is replaced by an empty
   macro.*/
#if CH_DBG_ENABLE_TRACE == FALSE && !defined(MOCK_RT)
...
#else
void chDbgAssert(bool c, char const * r);
#endif
/** @} */
...
#endif
#if (CH_DBG_ENABLE_TRACE == TRUE) || defined(__DOXYGEN__) || defined(MOCK_RT)
