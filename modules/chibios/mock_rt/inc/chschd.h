...
#else
void list_init(threads_list_t *tlp);
#endif
...
#else
bool list_isempty(threads_list_t *tlp);
#endif
...
#else
bool list_notempty(threads_list_t *tlp);
#endif
...
#else
void queue_init(threads_queue_t *tqp);
#endif
...
#else
bool queue_isempty(const threads_queue_t *tqp);
#endif
...
#else
bool chSchIsRescRequiredI(void);
#endif
