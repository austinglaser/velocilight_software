...
#define GPIOA_VIN_SENSE             2U
#define GPIOA_BATT_SENSE            3U
#define GPIOA_DAC_OUT1              4U
#define GPIOA_DAC_OUT2              5U
#define GPIOA_MIC0                  6U
#define GPIOA_MIC1                  7U
...
#define GPIOC_DIP0                  0U
#define GPIOC_DIP1                  1U
#define GPIOC_BATT_KILL             2U
#define GPIOC_CAN_S                 3U
#define GPIOC_PIN4                  4U
#define GPIOC_TEMPERATURE           5U
#define GPIOC_LTC4020_SHDN          6U
...
#define LINE_VIN_SENSE              PAL_LINE(GPIOA, 2U)
#define LINE_PWR_KILL               PAL_LINE(GPIOC, 2U)
#define LINE_LOAD_EN                PAL_LINE(GPIOC, 13U)
...
/* ADC */
#define LINE_MIC1_ADC                PAL_LINE(GPIOA, 7U)
#define LINE_MIC0_ADC                PAL_LINE(GPIOA, 6U)
...
#define LINE_IMU_INT                PAL_LINE(GPIOA, 15U)
 ...
 */
#define LINE_ESP32_RX               PAL_LINE(GPIOA, 9U)
#define LINE_ESP32_TX               PAL_LINE(GPIOA, 10U)
 ...
 * PA2  - VIN_SENSE                 (input analog).
 * PA3  - BATT_SENSE                (input analog).
 * PA4  - DAC_OUT1                  (DAC analog out).
 * PA5  - DAC_OUT2                  (DAC analog out).
 * PA6  - MIC0                      (input analog).
 * PA7  - MIC1                      (input analog).
 ...
 * PA15 - IMU_INT                   (input floating).
 */
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_PWR_INT) |        \
                                     PIN_MODE_ANALOG(GPIOA_5V_SENSE) |       \
                                     PIN_MODE_ANALOG(GPIOA_VIN_SENSE) |       \
                                     PIN_MODE_ANALOG(GPIOA_BATT_SENSE) |         \
                                     PIN_MODE_INPUT(GPIOA_DAC_OUT1) |        \
                                     PIN_MODE_INPUT(GPIOA_DAC_OUT2) |        \
                                     PIN_MODE_ANALOG(GPIOA_MIC0) |           \
                                     PIN_MODE_ANALOG(GPIOA_MIC1) |           \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_PWR_INT) |    \
                                     ...
                                     PIN_OTYPE_PUSHPULL(GPIOA_BATT_SENSE) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_DAC_OUT1) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOA_DAC_OUT2) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOA_MIC0) |       \
                                     PIN_OTYPE_PUSHPULL(GPIOA_MIC1) |       \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_FLOATING(GPIOA_PWR_INT) |    \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOA_BATT_SENSE) |      \
                                     PIN_PUPDR_FLOATING(GPIOA_DAC_OUT1) |    \
                                     PIN_PUPDR_FLOATING(GPIOA_DAC_OUT2) |    \
                                     PIN_PUPDR_FLOATING(GPIOA_MIC0) |         \
                                     PIN_PUPDR_FLOATING(GPIOA_MIC1) |         \
 ...
 * GPIOC setup:
 *
 * PC0  - DIP0                      (input floating).
 * PC1  - DIP1                      (input floating).
 * PC2  - BATT_KILL                 (input pullup).
 * PC3  - CAN_S                     (output pushpull, high).
 * PC4  - PIN4                      (input floating).
 * PC5  - TEMPERATURE               (input analog).
 * PC6  - LTC4020_SHDN              (output pushpull, low).
 ...
 * PC13 - LOAD_EN                   (output opendrain, low).
 * PC14 - OSC32_IN                  (input floating).
 * PC15 - OSC32_OUT                 (input floating).
 */
#define VAL_GPIOC_MODER             (PIN_MODE_INPUT(GPIOC_DIP0) |         \
                                     PIN_MODE_INPUT(GPIOC_DIP1) |         \
                                     PIN_MODE_INPUT(GPIOC_BATT_KILL) |         \
                                     PIN_MODE_OUTPUT(GPIOC_CAN_S) |       \
                                     PIN_MODE_INPUT(GPIOC_PIN4) |      \
                                     PIN_MODE_ANALOG(GPIOC_TEMPERATURE) |         \
                                     PIN_MODE_OUTPUT(GPIOC_LTC4020_SHDN) |         \
                                     ...
                                     PIN_MODE_OUTPUT(GPIOC_LOAD_EN) |        \
                                     PIN_MODE_INPUT(GPIOC_OSC32_IN) |     \
                                     PIN_MODE_INPUT(GPIOC_OSC32_OUT))
#define VAL_GPIOC_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOC_DIP0) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOC_DIP1) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOC_BATT_KILL) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOC_CAN_S) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOC_PIN4) |  \
                                     PIN_OTYPE_PUSHPULL(GPIOC_TEMPERATURE) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOC_LTC4020_SHDN) |     \
                                     ...
                                     PIN_OTYPE_OPENDRAIN(GPIOC_LOAD_EN) |    \
                                     PIN_OTYPE_PUSHPULL(GPIOC_OSC32_IN) | \
                                     PIN_OTYPE_PUSHPULL(GPIOC_OSC32_OUT))
#define VAL_GPIOC_OSPEEDR           (PIN_OSPEED_HIGH(GPIOC_DIP0) |        \
                                     PIN_OSPEED_HIGH(GPIOC_DIP1) |        \
                                     PIN_OSPEED_HIGH(GPIOC_BATT_KILL) |        \
                                     PIN_OSPEED_HIGH(GPIOC_CAN_S) |       \
                                     PIN_OSPEED_HIGH(GPIOC_PIN4) |     \
                                     PIN_OSPEED_HIGH(GPIOC_TEMPERATURE) |        \
                                     PIN_OSPEED_HIGH(GPIOC_LTC4020_SHDN) |        \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOC_LOAD_EN) |       \
                                     PIN_OSPEED_HIGH(GPIOC_OSC32_IN) |    \
                                     PIN_OSPEED_HIGH(GPIOC_OSC32_OUT))
#define VAL_GPIOC_PUPDR             (PIN_PUPDR_FLOATING(GPIOC_DIP0) |       \
                                     PIN_PUPDR_FLOATING(GPIOC_DIP1) |       \
                                     PIN_PUPDR_FLOATING(GPIOC_BATT_KILL) |       \
                                     PIN_PUPDR_FLOATING(GPIOC_CAN_S) |    \
                                     PIN_PUPDR_FLOATING(GPIOC_PIN4) |  \
                                     PIN_PUPDR_FLOATING(GPIOC_TEMPERATURE) |       \
                                     PIN_PUPDR_FLOATING(GPIOC_LTC4020_SHDN) |       \
                                     ...
                                     PIN_PUPDR_FLOATING(GPIOC_LOAD_EN) |      \
                                     PIN_PUPDR_FLOATING(GPIOC_OSC32_IN) | \
                                     PIN_PUPDR_FLOATING(GPIOC_OSC32_OUT))
#define VAL_GPIOC_ODR               (PIN_ODR_HIGH(GPIOC_DIP0) |           \
                                     PIN_ODR_HIGH(GPIOC_DIP1) |           \
                                     PIN_ODR_HIGH(GPIOC_BATT_KILL) |           \
                                     PIN_ODR_HIGH(GPIOC_CAN_S) |          \
                                     PIN_ODR_HIGH(GPIOC_PIN4) |        \
                                     PIN_ODR_HIGH(GPIOC_TEMPERATURE) |           \
                                     PIN_ODR_LOW(GPIOC_LTC4020_SHDN) |           \
                                     ...
                                     PIN_ODR_LOW(GPIOC_LOAD_EN) |          \
                                     PIN_ODR_HIGH(GPIOC_OSC32_IN) |       \
                                     PIN_ODR_HIGH(GPIOC_OSC32_OUT))
#define VAL_GPIOC_AFRL              (PIN_AFIO_AF(GPIOC_DIP0, 0U) |        \
                                     PIN_AFIO_AF(GPIOC_DIP1, 0U) |        \
                                     PIN_AFIO_AF(GPIOC_BATT_KILL, 0U) |        \
                                     PIN_AFIO_AF(GPIOC_CAN_S, 0U) |       \
                                     PIN_AFIO_AF(GPIOC_PIN4, 0U) |     \
                                     PIN_AFIO_AF(GPIOC_TEMPERATURE, 0U) |        \
                                     PIN_AFIO_AF(GPIOC_LTC4020_SHDN, 0U) |        \
